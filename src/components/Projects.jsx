import { Box, Image, Text, Flex, Heading, useColorModeValue, Stack } from "@chakra-ui/react";
            ...
            <Box p={6}>
                <Flex align="center" justify="space-between" mb={4}>
                    <Heading
                        ...
                        fontSize="xl" // Increased font size for better readability
                    >
                        AI Bee Health 
                    </Heading>
                </Flex>
                ...
                <Text mt={2} color={textColor} fontSize="md">
                    AI Bee Health is an innovative solution leveraging advanced deep learning models to detect and predict bee diseases,
                    ensuring healthier bee colonies and optimized honey production. This project represents our commitment to
                ...
                <Stack mt={4} direction="row" spacing={4} align="center" justify="flex-start">
                    <IconButton
                        aria-label="Watch on YouTube"
                        icon={<FaYoutube />}
                        size="lg"
                        colorScheme="red"
                        onClick={() => window.open('https://www.youtube.com/watch?v=hDdE1aI0mOM', '_blank')} // Replace with your YouTube video ID
                    />
                    <IconButton
                        ...
                        size="lg"
                        colorScheme="blue"
                        onClick={() => window.open('https://aibeehealth.ca', '_blank')} // Replace with your project URL
                    />
                </Stack>
            </Box>
        </Box>
